defmodule Nyanform.Profile.Constellation do
  ...
  @type t :: %__MODULE__{
          ...
          requires_additional_properties_false: boolean(),
          requires_root_object: boolean(),
